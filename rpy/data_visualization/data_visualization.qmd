...
## Expand to see data dictionary
```{r, echo=FALSE}


knitr::kable(
  data.frame(column = names(df),
           description = c("Pair identfier in the format subject vehicle ID-preceding vehicle ID",
                           "Elapsed time (s)",
                           "Actual time (s)",
                           "Duration of observation (s)",
                           "Identifier of subject vehicle",
                           "Identifier of time frame",
                           "Lateral position of the front center of subject vehicle from an arbitrary reference (m)",
                           "Longitudinal position of the front center of subject vehicle from an arbitrary reference (m)",
                           "Length of subject vehicle (m)",
                           "Width of subject vehicle (m)",
                           "Type of subject vehicle (1 = motorcyle, 2 = car, 3 = heavy-vehicle)",
                           "Speed of subject vehicle (m/s)",
                           "Acceleration of subject vehicle (m/s^2)",
                           "Current lane number of subject vehicle",
                           "Identifier of lead vehicle (vehicle in front of subject vehicle in the same lane)",
                           "Front bumper to front bumper distance between subject and lead vehicles (m)",
                           "Time required by the subject vehicle to traverse space headway (s)",
                           "Longitudinal position of the front center of lead vehicle from an arbitrary reference (m)",
                           "Length of lead vehicle (m)",
                           "Width of lead vehicle (m)",
                           "Type of lead vehicle (1 = motorcyle, 2 = car, 3 = heavy-vehicle)",
                           "Speed of lead vehicle (m/s)",
                           "Acceleration of lead vehicle (m/s^2)"))
)
```
:::
